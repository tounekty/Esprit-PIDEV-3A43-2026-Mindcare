 ...
 */
final class Version20260303230802 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE appointment (id INT AUTO_INCREMENT NOT NULL, date DATETIME NOT NULL, location VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, status VARCHAR(20) NOT NULL, zoom_meeting_id VARCHAR(255) DEFAULT NULL, zoom_join_url LONGTEXT DEFAULT NULL, zoom_created_at DATETIME DEFAULT NULL, report_name VARCHAR(255) DEFAULT NULL, report_updated_at DATETIME DEFAULT NULL, idetudiant INT DEFAULT NULL, idpsy INT DEFAULT NULL, patient_file_id INT DEFAULT NULL, INDEX IDX_FE38F844DBAB6AEE (idetudiant), INDEX IDX_FE38F8449F7E0988 (idpsy), INDEX IDX_FE38F844CEA82C87 (patient_file_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE entry_template (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, prompt LONGTEXT NOT NULL, category VARCHAR(50) NOT NULL, description LONGTEXT DEFAULT NULL, display_order INT NOT NULL, is_active TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, date_event DATETIME NOT NULL, lieu VARCHAR(255) NOT NULL, capacite INT NOT NULL, categorie VARCHAR(100) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, id_user INT NOT NULL, INDEX IDX_3BAE0AA76B3CA4B (id_user), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE journal_emotionnel (id INT AUTO_INCREMENT NOT NULL, contenu LONGTEXT DEFAULT NULL, dateecriture DATETIME NOT NULL, pdf_path VARCHAR(255) DEFAULT NULL, mood_id INT DEFAULT NULL, id_user INT NOT NULL, INDEX IDX_443F70FB889D33E (mood_id), INDEX IDX_443F70F6B3CA4B (id_user), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE message_forum (id INT AUTO_INCREMENT NOT NULL, contenu LONGTEXT NOT NULL, date_message DATETIME NOT NULL, is_anonymous TINYINT(1) NOT NULL, attachment_path VARCHAR(255) DEFAULT NULL, attachment_mime_type VARCHAR(100) DEFAULT NULL, attachment_size INT DEFAULT NULL, id_sujet INT NOT NULL, id_user INT NOT NULL, parent_message_id INT DEFAULT NULL, INDEX IDX_7A8D4126C09618AD (id_sujet), INDEX IDX_7A8D41266B3CA4B (id_user), INDEX IDX_7A8D412614399779 (parent_message_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE mood (id INT AUTO_INCREMENT NOT NULL, humeur VARCHAR(50) NOT NULL, intensite INT NOT NULL, datemood DATE NOT NULL, ai_analysis LONGTEXT DEFAULT NULL, pdf_path VARCHAR(255) DEFAULT NULL, id_user INT NOT NULL, INDEX IDX_339AEF66B3CA4B (id_user), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE psychological_alert (id INT AUTO_INCREMENT NOT NULL, alert_type VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, details LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, notified_admin TINYINT(1) NOT NULL, notified_psychologist TINYINT(1) NOT NULL, resolved TINYINT(1) NOT NULL, resolved_at DATETIME DEFAULT NULL, admin_notes LONGTEXT DEFAULT NULL, user_id INT NOT NULL, INDEX IDX_4071ECE5A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE reservation_event (id INT AUTO_INCREMENT NOT NULL, date_reservation DATETIME NOT NULL, statut VARCHAR(20) NOT NULL, nom VARCHAR(100) NOT NULL, prenom VARCHAR(100) NOT NULL, telephone VARCHAR(30) NOT NULL, commentaire LONGTEXT DEFAULT NULL, confirmation_token VARCHAR(64) DEFAULT NULL, sms_reminder_sent TINYINT(1) DEFAULT 0 NOT NULL, id_event INT NOT NULL, id_user INT NOT NULL, INDEX IDX_78D1DA00D52B4B97 (id_event), INDEX IDX_78D1DA006B3CA4B (id_user), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE sujet_forum (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, date_creation DATETIME NOT NULL, image_url VARCHAR(255) DEFAULT NULL, is_pinned TINYINT(1) NOT NULL, is_anonymous TINYINT(1) NOT NULL, status VARCHAR(50) DEFAULT NULL, category VARCHAR(100) DEFAULT NULL, attachment_path VARCHAR(255) DEFAULT NULL, attachment_mime_type VARCHAR(100) DEFAULT NULL, attachment_size INT DEFAULT NULL, id_user INT NOT NULL, INDEX IDX_EB9769ED6B3CA4B (id_user), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE entry_template');
