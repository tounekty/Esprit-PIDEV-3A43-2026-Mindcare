 ...
 */
final class Version20260211223930 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commentaire (id INT AUTO_INCREMENT NOT NULL, author_name VARCHAR(100) NOT NULL, author_email VARCHAR(180) NOT NULL, content LONGTEXT NOT NULL, rating INT DEFAULT NULL, created_at DATETIME NOT NULL, edit_token VARCHAR(64) DEFAULT NULL, approved TINYINT(1) NOT NULL, resource_id INT NOT NULL, INDEX IDX_67F068BC89329D25 (resource_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
